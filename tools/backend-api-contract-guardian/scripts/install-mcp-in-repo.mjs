...
async function main() {
  ...
  const serverName = args.name || 'backend-api-contract-guardian';
  ...
  if (!serverExists) {
    throw new Error(`Server dist file not found: ${serverDist}. Run "npm run build" in tools/backend-api-contract-guardian first.`);
  }
